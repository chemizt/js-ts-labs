function checkAgeSubroutine(age: number)
{
  return age > 18 ? true : false;
}

function minSubroutine(fC: number, sC: number)
{
...
{
  let result: number = n === 0 ? 1 : x * pow(x, n - 1);
  return result;
}

function sumSubroutine(number: number)
{
...
function fibAtIndex(index: number)
{
...
function checkAge()
{
  let input = document.getElementById('firstInput') as HTMLInputElement;
...
function findMin()
{
  ...
  let outcome = document.getElementById('output');
  let min = minSubroutine(parseInt(firstInput.value), parseInt(secondInput.value));
...
function numPower()
{
  let base = document.getElementById('firstInput') as HTMLInputElement;
  let exp = document.getElementById('secondInput') as HTMLInputElement;
  let outcome = document.getElementById('output');
