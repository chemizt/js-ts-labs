...
{
    let response = (document.getElementById('inputField') as HTMLInputElement).value;
...
function getSign() 
{
    ...
    let outcome = document.getElementById('result');
    let tmp = "";
    switch (Math.sign(parseInt(response)))
    {
        case 1:
            {
...
{
    let login = (document.getElementById('inputField') as HTMLInputElement).value;
    let password = (document.getElementById('passInputField') as HTMLInputElement).value;
    let outcome = document.getElementById('result');
    switch (login)
    {
        case 'admin':
...
{
    let outcome = document.getElementById('result');
    let age = parseInt((document.getElementById('inputField') as HTMLInputElement).value);
...
function startRequestLoop()
{
    ...
    do
    {
        var answer = parseInt(prompt('Введите число большее 100'));
...
{
    let outcome = document.getElementById('result');
    let upperBound = parseInt((document.getElementById('inputField') as HTMLInputElement).value);
...
{
    let outcome = document.getElementById('result');
    let browser = (document.getElementById('inputField') as HTMLInputElement).value;
