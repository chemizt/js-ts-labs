...
{
    var response = document.getElementById('inputField').value;
...
{
    var login = document.getElementById('inputField').value;
    var password = document.getElementById('passInputField').value;
    var outcome = document.getElementById('result');
    switch (login)
    {
        case 'admin':
...
{
    var outcome = document.getElementById('result');
    var age = parseInt(document.getElementById('inputField').value);
...
{
    var outcome = document.getElementById('result');
    var upperBound = parseInt(document.getElementById('inputField').value);
    if (Math.sign(upperBound) != NaN && upperBound >= 1)
    {
        ...
        {
            var isPrime = true;
            for (var j = 2; j <= i && isPrime; j++)
            {
                if (i % j == 0 && i != j)
                    isPrime = false;
                if (i === j)
                    outcome.innerHTML = outcome.innerHTML + i + ' ';
            }
        }
    }
    else
...
{
    var outcome = document.getElementById('result');
    var browser = document.getElementById('inputField').value;
